...
| 题目 | 一句话题解 |
| --- | --- |
| [2573.找出对应-lcp-矩阵的字符串](resolved/greedy/2573.找出对应-lcp-矩阵的字符串.java) | lcp[i][j] > 0, 说明有重复, 按照这个关系, 填完word, 最后验证由这个word得到的lcp矩阵是不是一致的 |
...
| 题目 | 一句话题解 |
| --- | --- |
| [3783.整数的镜像距离](resolved/math/3783.整数的镜像距离.java) |  |
...
| [3761.镜像对之间最小绝对距离](resolved/structure/3761.镜像对之间最小绝对距离.java) |  |
